...
app.layout = html.Div([
    html.H1(children='Automobile Statistics Dashboard', style={'textAlign': 'center'}),
    ...
    # Graph to display data based on selection
...
# Callback for updating the select-year dropdown based on the selected report type
@app.callback(
...
# Callback for updating the output container with graphs based on dropdown selection
@app.callback(
    ...
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(
                ...
                x='Year',
                y='Automobile_Sales',
                title="Automobile Sales Fluctuation Over Recession Period (Yearly)"
            )
        )

        # Plot 2: Average number of vehicles sold by vehicle type during recession (Bar chart)
        ...
        if selected_year:
            ...
            # Plot 3: Average number of vehicles sold during the given year (Bar Chart)
            ...
            return [html.Div("Please select a year to view the yearly statistics.")]
